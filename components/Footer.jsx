        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              >
                <img
                  src="/assets/socials/facebook-3-logo.svg"
                  alt=""
                />
              </a>
              ...
              >
                <img
                  src="/assets/socials/instagram-2-1-logo.svg"
                  alt=""
                />
              </a>
              ...
              >
                <img
                  src="/assets/socials/twitter-3-logo.svg"
                  alt=""
                />
              </a>
          ...
          <div className="md:col-span-2">
            <h3 className="font-700 text-[18px] mb-5 text-white">
              Company
            </h3>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-[14.5px] text-white/75">
              ...
              <li>
                <Link
                  href="/health-awareness-campaigns"
                  className="hover:text-teal transition-colors"
                >
                  Health Awareness
                </Link>
          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-5">
              <div className="font-700 text-[15px] text-white mb-1">
                Email
              </div>
